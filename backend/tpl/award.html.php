...
<div class="container" id="container">
    ...
    <div id="list-data">
        ...
        <table class="data table table-striped" cellspacing="0">
            <thead>
                <tr>
                    <th class="<?php echo $_HTML['col:award_id'] ?>" id="col-award_id" style="width:7%">編號</th>
                    ...
                    <th class="<?php echo $_HTML['col:opentime'] ?>" id="col-opentime">開放時間</th>
                    <th class="<?php echo $_HTML['col:status'] ?>" id="col-status" style="width:16%">狀態</th>
                </tr>
            </thead>
            <tbody>
